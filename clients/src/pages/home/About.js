            ...
            <div className="special-feature">
                ...
                <div className="row container w-100 p-3 mb-3 d-flex justify-content-center align-items-center">
                    ...
                    <div className="col-12 col-md-6 con" data-aos="fade-up">
                        <div className='player-wrapper'>
                            <ReactPlayer url="https://fb.watch/ekF7nIHe0O" height="100%" width="100%" />
                        </div>
                ...
                <div className="row container w-100 p-3 mb-3 d-flex justify-content-center align-items-center">
                    <div className="col-12 col-md-6 pe-3" data-aos="fade-up">
                        <div className='player-wrapper'>
                            <ReactPlayer url="https://fb.watch/ekF6FdfCGx" height="100%" width="100%" />
                        </div>
                ...
                <div className="row container w-100 p-3 mb-3 d-flex justify-content-center align-items-center">
                    ...
                    <div className="col-12 col-md-6 con" data-aos="fade-up">
                        <div className='player-wrapper'>
                            <ReactPlayer url="https://fb.watch/ekFrX78ve7" height="100%" width="100%" />
                        </div>
                ...
                <div className="row container w-100 p-3 mb-3 d-flex justify-content-center align-items-center">
                    <div className="col-12 col-md-6 pe-3" data-aos="fade-up">
                        <div className='player-wrapper'>
                            <ReactPlayer url="https://fb.watch/ekFucaitsc" height="100%" width="100%" />
                        </div>
